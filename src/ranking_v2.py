...
class ProductRankerV2:
    ...
    def _apply_business_rules(self, 
        ...
        # Правило 2: Карта для путешествий для тех, кто тратит на такси/путешествия
        if product == 'Карта для путешествий':
            taxi_spend = features.get('spend_Такси', 0)
            travel_spend = features.get('spend_Путешествия', 0)
            if taxi_spend + travel_spend > 50000:  # Более 50k на такси/путешествия
        ...
        # Правило 6: Снижаем кредит наличными (уже сделано в scoring)
